          ...
          <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl w-full max-w-sm overflow-hidden animate-in fade-in zoom-in duration-200">
            ...
            <form onSubmit={handleSaveEdit} className="p-5 space-y-4">
              ...
              <div>
                ...
                <select value={editingJadwal.guru_id || ''} onChange={(e) => setEditingJadwal({ ...editingJadwal, guru_id: e.target.value })} className="w-full px-3 py-2 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg text-sm">
