  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      <div className="text-center py-8 bg-gradient-to-br from-[#064e3b] to-[#022c22] rounded-3xl shadow-lg border border-green-800/50 overflow-hidden relative transition-colors duration-300">
        ...
        {/* Tanggal — Presisi 50:50 Masehi (Cinzel) | Hijriyah (Ringkas, Fit & Elegan) */}
        <div className="mt-6 flex items-center justify-center w-full px-2">
          <div className="grid grid-cols-[1fr_auto_1fr] items-center justify-center bg-[#0f172a]/90 backdrop-blur-md px-4 sm:px-6 py-2 sm:py-2.5 rounded-full shadow-lg border border-gray-800/90 transition-all duration-300 w-fit max-w-[96%] sm:max-w-max mx-auto gap-2 sm:gap-3">
            {/* Kolom Kiri: Masehi (Cinzel Font, rata kanan mendekati pemisah) */}
            <div className="flex items-center justify-end min-w-0">
              <span
                className="text-[10px] xs:text-[11px] sm:text-xs text-slate-100 font-bold tracking-normal sm:tracking-wider text-right whitespace-nowrap"
            ...
            <div className="px-0.5 sm:px-1 flex items-center justify-center shrink-0">
              ...
              <span className="sm:hidden text-emerald-400/80 font-bold select-none text-[10px]">•</span>
            </div>

            {/* Kolom Kanan: Hijriyah (Presisi 50%, rata kiri mendekati pemisah) */}
            <div className="flex items-center justify-start min-w-0">
              <span
                className="text-[11px] xs:text-[12px] sm:text-xs text-emerald-400 font-bold leading-none text-left whitespace-nowrap"
