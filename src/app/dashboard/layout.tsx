  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-300 flex flex-col">
      ...
      {showSidebar && (
        <>
          ...
          <aside className="fixed top-0 right-0 h-full w-72 bg-white dark:bg-gray-900 shadow-2xl z-[70] flex flex-col rounded-l-3xl overflow-hidden">
            {(() => {
              ...
              const isLongName = userName.length > 16 || userName.includes('\n');
              return (
                <div className="px-3.5 py-2.5 border-b border-green-700/30 dark:border-gray-800 flex flex-col bg-gradient-to-r from-green-900 via-green-800 to-gray-900 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 text-white rounded-b-2xl shadow-md relative z-10">
                  ...
                  <div className={`flex ${isLongName ? 'items-start' : 'items-center'} justify-between gap-2 w-full`}>
                    <div
                      className={`${sidebarAvatar ? 'w-8 h-8 rounded-full overflow-hidden border-2 border-white/40 flex-shrink-0' : 'bg-white p-1.5 rounded-full flex-shrink-0'} ${isLongName ? 'mt-0.5' : ''} ${sidebarAvatar ? 'cursor-pointer hover:ring-2 hover:ring-white/60 transition-all' : ''}`}
                    ...
                    <div className={`flex-1 min-w-0 px-1 text-center ${isLongName ? 'pt-0.5' : 'py-0.5'}`}>
            ...
            {openSections.menuUtama && (
              <ul className="space-y-1 mt-2 pl-1 pr-1 animate-[fadeIn_0.2s_ease-out]">
                ...
                {!(user?.role || '').toLowerCase().includes('petugas') && (() => {
                  const hasPresensiSection = ['admin', 'staff', 'pengurus_asrama', 'pengasuh', 'guru'].includes(userRoleLower) || isPengasuhRole;

                  return (
                    <>
                      {/* Sub-kategori 1: Presensi & Kehadiran */}
                      {hasPresensiSection && (
                        <>
                          <li className="pt-2.5 pb-1 px-3">
                            <div className="flex items-center gap-2">
                              <span className="text-[10px] font-bold tracking-wider text-gray-400 dark:text-gray-500 uppercase">
                                Presensi & Kehadiran
                              </span>
                              <div className="flex-1 h-[1px] bg-gray-200/70 dark:bg-gray-700/50"></div>
                            </div>
                          </li>
                          <li>
                      ...
                      {/* Sub-kategori 3: Kedisiplinan & Asrama */}
                      <li className="pt-3 pb-1 px-3">
                        <div className="flex items-center gap-2">
                          <span className="text-[10px] font-bold tracking-wider text-gray-400 dark:text-gray-500 uppercase">
                            Kedisiplinan & Asrama
          ...
          {!isTamu && !(user?.role || '').toLowerCase().includes('petugas') && (
            <div className="px-3 mb-3">
              ...
              {openSections.manajemenData && (() => {
                ...
                return (
                  <ul className="space-y-1 mt-2 pl-1 pr-1 animate-[fadeIn_0.2s_ease-out]">
                    {/* Sub-kategori 1: Santri & Akademik */}
                    {hasAkademikSection && (
                      <>
                        {showSubDividers && (
                          <li className="pt-1.5 pb-1 px-3">
                            <div className="flex items-center gap-2">
                              <span className="text-[10px] font-bold tracking-wider text-gray-400 dark:text-gray-500 uppercase">
                                Santri & Akademik
                              </span>
                    ...
                    {/* Sub-kategori 2: Jadwal & Pengajar */}
                    {hasJadwalSection && (
                      <>
                        {showSubDividers && (
                          <li className="pt-3 pb-1 px-3">
        ...
        <div className="px-3.5 py-2.5 border-t border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-gray-900/90 flex flex-col gap-1.5 rounded-t-2xl shadow-[0_-5px_15px_rgba(0,0,0,0.05)] dark:shadow-[0_-5px_15px_rgba(0,0,0,0.3)] relative z-10">
          <a 
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex w-full items-center gap-2.5 px-3 py-2 rounded-xl bg-[#25D366] hover:bg-[#1DA851] text-white transition-colors font-bold shadow-sm text-xs"
          ...
          <button 
            ...
            className="flex w-full items-center gap-2.5 px-3 py-2 rounded-xl hover:bg-red-50 dark:hover:bg-red-900/20 text-red-600 dark:text-red-400 transition-colors font-bold text-xs"
          >
            <LogOut size={17} />
            <span>Keluar</span>
          </button>
