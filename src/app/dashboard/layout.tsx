  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-300 flex flex-col">
      ...
      {showSidebar && (
        ...
        <div className="px-3.5 py-2 border-t border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-gray-900/90 flex flex-col gap-1.5 rounded-t-2xl shadow-[0_-5px_15px_rgba(0,0,0,0.05)] dark:shadow-[0_-5px_15px_rgba(0,0,0,0.3)] relative z-10">
          <a 
